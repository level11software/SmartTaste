...
const Recipe = ({recipe, removal, saveAction, openDetail}) => {
    ...
    return (
        <div>
            <motion.div
                className="card card-compact w-80 bg-base-100 h-full shadow-xl"
                whileHover={{
                    scale: 1.05,
      ...
      Conditional opacity onClick={() => handleClick(title)}> */}
                ...
                <div className="card-body">
                    <h2 className="card-title font-medium text-md">{name}</h2>
                    ...
                    <div className="flex flex-wrap ">
                        {tags_list.split(", ").map((tag) => (
                            <span
                                key={tag}
                                className="badge-primary text-white text-xs  mr-1 px-1.5 py-0.5 my-0.5 rounded"
                            >
                {tag}
              </span>
                        ))}
                ...
                <div className="flex flex-row justify-between">
                    <div className="ml-3 mt-4 font-light text-sm italic">around {preptime}m</div>
                ...
                <div className="modal-box">
                    ...
                    <div className="flex flex-row justify-around">
                        <div className="flex flex-col w-2/5">
                            <h4 className="text-lg text-accent font-bold mt-4 ">
                                Allergens
                            </h4>
                        ...
                        <div className="flex flex-col w-2/5">
                            <h4 className="text-lg text-secondary font-bold mt-4 ">
                                Ingredients
                            </h4>
                    ...
                    <div className="modal-action">
                        ...
                        <div className={"flex row  p-3 pr-11"}>
                            Carbs:
                            <div className="badge badge-warning ml-2 mr-2">
                                {" "}
